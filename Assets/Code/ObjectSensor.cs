...
public class ObjectSensor : MonoBehaviour {
    ...
    [SerializeField] private CollisionEvent detectedSomething_Collision;
    [SerializeField] private ColliderEvent detectedSomething_Collider;
    ...
    private void InvokeDetectedSomething(Collision col) {
        detectedSomething_Collision.Invoke(col);
    }

    private void InvokeDetectedSomething(Collider col) {
        detectedSomething_Collider.Invoke(col);
    }
